...
export const NewCanvasModal = ({ controller }: { controller: AppController }) => {
    ...
    const aspectRatioRef = useRef(800 / 600);
    ...
    const handleLinkToggle = () => {
        if (!isLinked && typeof width === 'number' && typeof height === 'number' && width > 0 && height > 0) {
        ...
        <ModalBase widthClass="max-w-md">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button type="button" onClick={handleLinkToggle} className="self-end p-2 mb-1 bg-background-tertiary hover:bg-accent-primary rounded-md" title={isLinked ? "Unlink Aspect Ratio" : "Link Aspect Ratio"}>
